...
cfssl gencert -ca=$SECRETS_DIR/ca.pem \
	...
	-hostname=etcd1.${INTERNAL_TLD},etcd2.${INTERNAL_TLD},etcd3.${INTERNAL_TLD},${ETCD_IPS},${MASTER_IPS},controller1.${INTERNAL_TLD},controller2.${INTERNAL_TLD},controller3.${INTERNAL_TLD},${KUBE_API_PUBLIC_FQDN},${KUBE_API_INTERNAL_IP},10.0.0.1,127.0.0.1,kubernetes.default \
